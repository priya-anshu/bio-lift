...
// Initialize Firebase Admin FIRST (before importing rankingEngine)
if (!admin.apps.length) {
  try {
    ...
    console.error('Make sure you have serviceAccountKey.json in the server directory');
    process.exit(1);
  }
}

// Now import rankingEngine (after Firebase is initialized)
...
// Start server
app.listen(PORT, () => {
  console.log(`🚀 BioLift Ranking Server running on port ${PORT}`);
